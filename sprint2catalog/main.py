...
from loading_window import LoadingWindow #Importamos la clase MainWindow
...
if __name__ == "__main__": #Verificamos si la ejecución es la del main. 
    ...
    app = LoadingWindow(root) #Creamos una instancia de la clase MainWindow (al cual pasaremos root como parámetro) y la guardamos en la variable app
